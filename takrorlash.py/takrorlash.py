...
# """___________________9g005__________________"""

# son=int(input("1-son kiriting : "))
# son1=int(input(" 2-son kiriting : "))

# print(range(son,son1))

# """2 exercise """
# ism=input("ismizzi  kiriting : ")
# a=[]
# for i in range(5):
#     a.append(input(f"{ism} {i+1} - kitob nomini kiriting "))
# del a[-1]
# print(a)
# a.insert(2,"xayot")
# a.insert(3,"sarvinozxonim")
